...
{
    class Problems_Trees_CheckIfTreeIsBST
    {
        //Create an algorithm to verify if a tree is a BST
        //In order tree transversal while tracking last node

        //O(n) time
        //O(log n) space for each recursive call if performed on a balanced tree
        ...
        public void Run()
        {
            ...
            Console.WriteLine("Is BST: " + tree.IsBST());
